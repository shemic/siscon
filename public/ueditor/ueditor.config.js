...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:upload_img_url            //图片上传提交地址
        ...
        /*
		, toolbars:[
            ['undo', 'redo', '|','bold', 'italic', 'underline', 'forecolor', 'backcolor', 'fontfamily', 'fontsize', 
			'formatmatch', 'justifyleft', 'justifycenter', 'insertimage', 'cleardoc',]
        ]*/
...
//        }
        ...
        ,initialFrameHeight:515  //初始化编辑器高度,默认320
        ...
        //,initialStyle:'p{line-height:1em}'//可以用来改变字体等
