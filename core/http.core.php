...
class Http
{
	 ...
	 * @return void
	 */
    public function save($request_file_url, $save_to_filepath){
     ...
     * @param string 请求方法 (GET or POST or upload) (optional)
     * @param array 请求数据, key 和 value 对应的数组 (optional)
     * @return string 请求的结果集
     */    
	public function execute($target = '', $referrer = '', $method = '', $data = array(), $extra_params =array() )
    {
		...
		//Debug::log($this->target, $logarr ,"HTTP");
